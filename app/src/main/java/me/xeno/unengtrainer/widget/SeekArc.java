...
public class SeekArc extends View {
    ...
    public interface OnSeekArcChangeListener {
         ...
         *                 0..max where max was set b. (The default value for
         *                 max is 100.)
    ...
    public SeekArc(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, android.R.attr.seekBarStyle);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        int arcColor = res.getColor(R.color.greyCC);
        int progressColor = res.getColor(R.color.colorPrimary);
        int thumbHalfheight = 0;
        int thumbHalfWidth = 0;
        mThumb = res.getDrawable(R.drawable.selector_seek_arc);
